...
landing-page-description: Vea esta serie de vídeos para conocer a los Progressive Web Application (PWA) y por qué PWA Studio es el futuro de [!DNL Commerce] sites.
short-description: Vea esta serie de vídeos para conocer a los Progressive Web Application (PWA) y por qué PWA Studio es el futuro de [!DNL Commerce] sites.
kt: 5644
doc-type: video
activity: use
