---
title: Creación agéntica
description: Descubra cómo Experience Workspace utiliza un asistente de IA auténtico para crear páginas de tienda de marca a partir de indicaciones en lenguaje natural conectadas a su catálogo en directo.
role: User
level: Beginner
...
* Desarrolladores de tiendas

## Contenido de vídeo

* Superficie de creación unificada con estructura de archivos, contenido de página y vista previa en directo en paralelo
* Asistente de creación de IA conectado al catálogo de productos mediante MCP
* Solicitar a la biblioteca y al Generador de habilidades que amplíen las capacidades del asistente
