...
* El servicio de catálogo, que incluye búsquedas en directo y recomendaciones de productos, está incluido en Adobe Commerce y tiene guías disponibles en Experience League.
...
* Edge Delivery Services, lanzado recientemente para Adobe Commerce, ofrece soluciones de tienda de alto rendimiento con baja latencia y experiencias de creación simplificadas.
* Edge Delivery Services da prioridad al rendimiento y puede mejorar significativamente las puntuaciones de Lightthouse, la SEO y la velocidad general del sitio web.
