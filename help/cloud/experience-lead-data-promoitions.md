...
Obtenga información sobre las funciones de búsqueda avanzada de Adobe Commerce, con tecnología de Adobe AI, y sus sólidas funciones de administración de catálogos. Conozca algunos de los aspectos destacados de las herramientas de optimización, faceteo y comercialización de búsqueda impulsadas por IA para mejorar la experiencia del usuario. Además, aprenderá sobre la agrupación de productos, la gestión de promociones y la integración perfecta con sistemas de terceros, ofreciendo una solución completa para las necesidades de comercio electrónico B2B y B2C.
...
Descubra las potentes herramientas de administración de catálogos de Adobe Commerce diseñadas para administradores y desarrolladores de comercio electrónico. Gestione sin esfuerzo listados de productos, inventario, precios y promociones con funciones intuitivas de programación y automatización. Integre sin problemas con sistemas de terceros y aproveche servicios avanzados como búsquedas en directo y recomendaciones de productos. Aproveche la sólida ingesta de datos mediante API y sincronización en tiempo real, todo mientras mejora su tienda con contenido generado por IA desde Adobe Experience Manager. Mejore su experiencia de comercio electrónico y manténgase ágil en un mercado dinámico con Adobe Commerce.  
...
>[!VIDEO](https://video.tv.adobe.com/v/3434067?captions=spa&learn=on)

## Live Search

Descubra las funcionalidades de búsqueda avanzada de Adobe Commerce Live Search, con tecnología de Adobe AI. Esta sólida solución de SaaS mejora la experiencia de comercio electrónico al ofrecer resultados de búsqueda muy relevantes de forma rápida y eficaz. Los comerciantes y especialistas en marketing pueden optimizar los resultados de búsqueda del sitio mediante herramientas como reglas de búsqueda avanzadas, sinónimos y facetas. Live Search ofrece sugerencias en tiempo real, clasificación inteligente y experiencias de búsqueda personalizables, lo que garantiza que los clientes encuentren lo que necesitan. También admite modelos B2B con catálogos compartidos y precios específicos, lo que lo convierte en una solución versátil para todas las necesidades comerciales.
...
>[!VIDEO](https://video.tv.adobe.com/v/3434045?captions=spa&learn=on)
...
>[!VIDEO](https://video.tv.adobe.com/v/3434056?captions=spa&learn=on)
>
