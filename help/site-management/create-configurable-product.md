...
1. Obtenga los atributos de un [conjunto de atributos](https://experienceleague.adobe.com/docs/commerce-admin/catalog/product-attributes/create/attribute-sets.html) para usar los números de identificación en llamadas de API posteriores.
...
Para recuperar los identificadores de atributo para configurar su producto configurable, actualice la porción `attribute-sets/10/attributes` de la siguiente solicitud cURL para reemplazar `10` con el identificador del conjunto de atributos en su entorno. Esta solicitud utiliza el método GET.
...
Cree el primer producto simple con la API para enviar la siguiente petición POST mediante cURL.
...
Cree el segundo producto simple con la API para enviar la siguiente petición POST mediante cURL.
...
Cree el tercer producto simple enviando la siguiente petición POST usando cURL.
...
Cree un producto configurable vacío enviando la siguiente petición POST mediante cURL.
...
Defina las opciones disponibles para el producto configurable enviando la siguiente petición POST mediante cURL.
...
Añada estos productos simples como secundarios del producto configurable enviando la siguiente petición POST. Envíe una solicitud independiente para cada producto.
...
Lo siguiente utiliza el método GET
...
* [Tutorial sobre Creación de un producto configurable](https://developer.adobe.com/commerce/webapi/rest/tutorials/configurable-product/){target="_blank"}
* [Producto configurable](https://experienceleague.adobe.com/docs/commerce-admin/catalog/products/types/product-create-configurable.html){target="_blank"}
